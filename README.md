...
- esto quiere decir que la emisión de las pólizas depende síncronamente del rating service:
si el rating service no responde, la emisión no ocurre -> el sistema prioriza consistencia sobre disponibilidad.
...
otro motivo?
- además se podría usar lombok para evitar el boilerplate (o features equivalentes de java mas nuevo)
- 
